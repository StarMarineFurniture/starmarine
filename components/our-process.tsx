...
const OurProcess = () => {
  return (
    <section className="py-10 lg:py-20" id="our-process">
         ...
         <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-8 w-full">
               ...
               <div className="md:hidden overflow-x-auto pb-4 scrollbar-hide">
                  <ul className="flex gap-5 w-max pt-4 px-4">
                     {processSteps.map((process, i) => (
                        ...
                        <Card className="p-6 h-full text-left relative">
               ...
               <div className="hidden md:flex justify-center">
                  <ul className="grid grid-cols-2 gap-5 lg:grid-cols-4 max-w-5xl">
                     {processSteps.map((process, i) => (
                        <li key={i}>
                        <Card className="p-6 h-full text-left relative">
                           <div className="absolute -top-3 -left-3 w-8 h-8 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-bold">
